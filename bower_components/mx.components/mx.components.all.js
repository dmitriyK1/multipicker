	...
	var MxMultiPickerControllerBase = function($timeout, $q, $element, $scope, internationalization) {
		...
		function _setLabels() {
			if (vm.selectedItems.length > 0 || vm._isTyping) {
				...
				vm.controlLabel = vm.label || vm.defaultPickerLabel;
		}
